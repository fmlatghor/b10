...
static uint32_t s_addrStart = 0x00200000; // Start at address 0x00200000.
...
void extapp_main()
{
    ...
    while (true) {
        ...
        switch (pressed) {
		// pretty sure the scancode prefix means when a key is pressed. Not any key, the key specified.
            // case SCANCODE_Zero:
